...
if(isset($_POST['btnDongY'])){
	 if(isset($_SESSION["tendangnhap"])){
	   ...
	   echo "<script>window.location='?khoatrang=thanhtoan';</script>";
		 ...
		 echo "<script>alert('Vui long dang nhap truoc khi thanh toan');</script>";
	 }
}
    ...
    ?>
				...
				<?php
					...
					echo "<div class='row'><div class='col-sm-12' align='right'>
						<label>Tong tien</label>: <span class='gia'>"
						.number_format($tong,0,",",".")."</span> dong </div></div>";
   				}else{
					echo"<div class='row'><div class='col-sm-12'>Chua co san pham trong gio hang</div></div>";
				}
                ?>
	<div class='row'>
