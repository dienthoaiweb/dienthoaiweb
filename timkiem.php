 ...
 <script>
 	function timkiem()
	{
		...
		if(tukhoa=="")
		{
			alert("Nhap tu khoa de tim kiem");
			return false;	
		}
                    ...
                    <div class="latest-product">
                        ...
                        <!--Load san pham tu DB -->
                           <?php
							...
							$query="SELECT a.*,(SELECT b.hsp_tentaptin FROM hinhsanpham b WHERE a.sp_ma = b.sp_ma LIMIT 0,1) as sp_hinhdaidien FROM sanpham a where sp_ten like '%".$tukhoa."%' and sp_gia>=".$giatu." and sp_gia<=".$giaden;
							if($hang>0)
							{
								$query.=" and a.nsx_ma=".$hang;
							}
							if($loai>0)
							{
								$query.=" and a.lsp_ma=".$loai;
							}
