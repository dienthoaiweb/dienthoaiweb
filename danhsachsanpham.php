            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="single-product-widget">
                        ...
                        <?php
							$sqstr="SELECT a.*,(SELECT b.hsp_tentaptin from hinhsanpham b where a.sp_ma=b.sp_ma 
							LIMIT 0,1) AS hsp_tentaptin, (SELECT SUM(sp_dh_soluong) FROM sanpham_dondathang c WHERE
							a.sp_ma=c.sp_ma) AS soluong FROM sanpham a ORDER BY soluong DESC LIMIT 0,3";
                ...
                <div class="col-md-4">
                    <div class="single-product-widget">
                        ...
                        <a href="#" class="wid-view-more">Xem tất cả</a>
                         <?php
							$sqstr="SELECT a.*,(SELECT b.hsp_tentaptin from hinhsanpham b where a.sp_ma=b.sp_ma 
							LIMIT 0,1) AS hsp_tentaptin FROM sanpham a ORDER BY sp_ngaycapnhat DESC LIMIT 0,3";
							$result=mysqli_query($conn,$sqstr);
							while($rs=mysqli_fetch_array($result,MYSQLI_ASSOC))
							{
						?>
                        <div class="single-wid-product">
                            ...
                            <a href="index.php?khoatrang=quanly_chitietsanpham&ma=<?php echo $rs['sp_ma'] ?>">
                            <img src="product-imgs/<?php echo $rs['hsp_tentaptin'] ?>" alt="" class="product-thumb">
                            </a>
                            <h2><a href="index.php?khoatrang=quanly_chitietsanpham&ma=<?php echo $rs['sp_ma']; ?>"
                            </a></h2>
                            <div class="product-wid-rating">
